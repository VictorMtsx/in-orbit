...
export function DialogTrigger(props: DialogPrimitive.DialogTriggerProps & { children: React.ReactNode }) {
  return <DialogPrimitive.DialogTrigger {...props} />
}

export function DialogClose(props: DialogPrimitive.DialogCloseProps & { children: React.ReactNode }) {
